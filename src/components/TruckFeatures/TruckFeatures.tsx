...
// export default function TruckFeatures: React.FC() {
//   const { selectedTruck } = useAppSelector((state) => state.campers);
//   // const { selectedTruck } = useSelector((state: RootState) => state.campers);
